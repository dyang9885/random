...
static int gen_vals(int test_vals[], int min, int max, int test_range, int arg)
{
     ...
     */
    if ((min == 1 && max == 1)) {
        unsigned smallest_denorm = 0x00000001;
        unsigned largest_denorm  = 0x007fffff;
        unsigned smallest_norm   = 0x00800000;
        unsigned one             = 0x3f800000;
        unsigned largest_norm    = 0x7f7fffff;
        unsigned inf             = 0x7f800000;
        unsigned nan1            = 0x7f800001;
        unsigned nan2            = 0x7fc00000;
        unsigned nan3            = 0x7fffffff;
        ...
        for (i = 0; i < test_range; i++) {
	        ...
	        /* Region around one in floating-point value */
	        test_vals[test_count++] = f2uint(1.0 + i);
	        test_vals[test_count++] = f2uint(1.0 - i);
        ...
        /* special vals */
        test_vals[test_count++] = smallest_denorm;
        test_vals[test_count++] = sign | smallest_denorm;
        test_vals[test_count++] = largest_denorm;
        test_vals[test_count++] = sign | largest_denorm;
        test_vals[test_count++] = smallest_norm;
        test_vals[test_count++] = sign | smallest_norm;
        test_vals[test_count++] = largest_norm;
        test_vals[test_count++] = sign | largest_norm;
        test_vals[test_count++] = inf;
        test_vals[test_count++] = sign | inf;
        test_vals[test_count++] = nan1;
        test_vals[test_count++] = sign | nan1;
        test_vals[test_count++] = nan2;
        test_vals[test_count++] = sign | nan2;
        test_vals[test_count++] = nan3;
        test_vals[test_count++] = sign | nan3;
        test_vals[test_count++] = 0x7f700000;
        test_vals[test_count++] = 0xff700000;
        return test_count;
    }
